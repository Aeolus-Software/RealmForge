...
course deliverable. They should have a descriptive name, detailed description, 
and be linked to the issues required to complete the deliverable.
...
or other purposes if needed (and time is available for their construction).
